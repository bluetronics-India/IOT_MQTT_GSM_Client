...
String MQTT_HOST = "server host here";
/*
   MQTT host address
*/
String MQTT_PORT = "port here";
/*
   MQTT port
*/
...
void GSM_MQTT::AutoConnect(void)
{
  ...
  */
  connect("client here", 1, 1, "username", "password", 0, 0, 0, 0, "", "");
...
void GSM_MQTT::OnConnect(void)
{
  ...
  */
  subscribe(0, _generateMessageID(), "SampleTopicIn", 1);
  ...
  */
  ...
  publish(0, 0, 0, _generateMessageID(), "SampleTopic", "Initializing...");
...
void GSM_MQTT::OnMessage(char *Topic, int TopicLength, char *Message, int MessageLength)
{
  /*
    ...
    put your subscription publish codes here.
  */
  if(strcmp(Topic, "SampleTopicIn") == 0)
  {
    scaleFactor = atoi(Message);
    dataValue = 10*scaleFactor;
    sprintf (data, "%03i", dataValue);
    publish(0, 0, 0, 234, "SampleTopic", data);
  }
  /*
